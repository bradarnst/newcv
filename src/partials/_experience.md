...
###### Various Roles/Companies &mdash; Canada and UK | 1994...2007

###### Web Architect at Petro-Canada

###### Senior Technical Architect at NETeller

###### Web Architect at Burlington Resources

###### Senior Technical Lead at ENMAX Corporation
...
- Led large-scale migration projects, overseeing analysis, planning, and implementation of data, user, and application moves.
- Mentored and managed technical teams, refining procedures, standards, and architecture to align with business objectives.
- Proficient in a wide range of technologies including AD, Exchange, Oracle, SQL Server, IIS, Apache, and more.

• Security Architecture • PCI Compliance • Active Directory (AD) • Exchange • Oracle • SQL Server • IIS • Apache • Middleware Platforms (WebLogic, Tomcat) • Monitoring & Reporting • Networking • DNS • Encryption • ITIL • Storage Solutions • Web Services • Linux • Windows Server Environment • Technical Leadership • Team Management •
